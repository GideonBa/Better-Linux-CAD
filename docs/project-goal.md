...
Blocks 48–91 establish Body identity, body-scoped recompute/inspection, Body Booleans, associative
...
persistent Surface-feature family plus executed Boundary/Fill, Trim/Extend, and Stitch/Knit/Sew
shell Surface Geometry. The current next technical step is Block 92 Closed shell to solid
conversion.
STEP Part and
