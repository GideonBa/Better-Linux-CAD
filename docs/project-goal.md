...
Blocks 48–88 establish Body identity, body-scoped recompute/inspection, Body Booleans, associative
...
persistent Surface-feature family. The current next technical step is Block 89 Boundary and Fill
Surface Geometry.
STEP Part and
