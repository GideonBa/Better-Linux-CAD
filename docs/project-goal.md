...
Blocks 48–89 establish Body identity, body-scoped recompute/inspection, Body Booleans, associative
...
persistent Surface-feature family plus executed Boundary/Fill Surface Geometry. The current next
