...
- part-scope expression parameters: unit-aware formulas over other part parameters with graph-driven topological re-evaluation (`docs/parameter-expression-mvp.md`).
