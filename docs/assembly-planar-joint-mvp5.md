...
Point/Point center coincidence with explicit selected-drive rejection. Blocks 48–75 Part
Construction through DraftFeature Geometry are implemented; Block 75 Basic 3D Sketch Core intent
is next.
