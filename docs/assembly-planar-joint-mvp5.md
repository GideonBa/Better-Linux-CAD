...
Point/Point center coincidence with explicit selected-drive rejection. Blocks 48–59 Body identity,
body-scoped recompute/inspection, Body Booleans, and BodyTransform/SketchOwnership intent are
implemented; Block 60 richer Extrude/Cut Geometry is next.
