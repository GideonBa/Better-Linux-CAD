...
Point/Point center coincidence with explicit selected-drive rejection. Blocks 48–76 Part
Construction through richer 3D curve intent are implemented; Block 77 3D Sketch JSON and semantic
references is next.
