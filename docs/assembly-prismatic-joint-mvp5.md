...
documents. Blocks 48–83 Part Construction through Path-following Extrude and Extruded Cut are
implemented; Block 84 ProfileSectionReference and Loft Core intent plus JSON is next.
