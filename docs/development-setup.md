...
mouse dragging, complete creation/modify/dimension surfaces, and acceptance. Blocks 122–128 then
plan STEP import as either an immutable Assembly-ready Reference Part or an EditableBody
`ImportedBodyFeature` with downstream BLCAD features. Canonical sequencing:
`docs/interactive-sketcher-sequence-mvp8.md` and `docs/step-import-sequence-mvp9.md`.
