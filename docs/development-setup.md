...
- Qt 6 packages for the completed Blocks 95–105 GUI Validation phase
- nlohmann-json
- Catch2
...
## GUI build and Blocks 95–105 tests
...
projection, the planar Sketch workbench, and foundational parameter/Body/solid-feature workflows.
The completed phase covers browser/properties, all implemented Sketch/Part/Surface/Assembly workflows, analysis,
exchange, and integrated GUI/headless feature coverage. Canonical sequencing:
`docs/gui-feature-validation-sequence-mvp7.md`.

Blocks 106–121 plan the Interactive Sketcher, including shared point topology, constraint solving,
mouse dragging, complete creation/modify/dimension surfaces, and acceptance. Blocks 122–131 then
plan interactive Part/Surface/Assembly modeling with preselection-driven commands, viewport
manipulators, live previews, feature editing, and joint motion manipulation. Blocks 132–138 plan
STEP import as either an immutable Assembly-ready Reference Part or an EditableBody
`ImportedBodyFeature` with downstream BLCAD features. Canonical sequencing:
`docs/interactive-sketcher-sequence-mvp8.md`, `docs/interactive-modeling-sequence-mvp9.md`, and
