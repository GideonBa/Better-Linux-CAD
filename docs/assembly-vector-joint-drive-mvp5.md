...
is explicitly rejected as the selected drive. Blocks 48–53 Body identity, persistent feature
Body-result operations, body-scoped recompute, and checked inspection are implemented; Block 54
BodyBooleanFeature Core intent and JSON is the next technical step.
