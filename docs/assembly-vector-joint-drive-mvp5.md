...
is explicitly rejected as the selected drive. Blocks 48–57 Body identity, body-scoped
recompute/inspection, Body Booleans, and BodyTransform/SketchOwnership intent are implemented;
Block 58 Part feature semantic input reference contract is next technical step.
