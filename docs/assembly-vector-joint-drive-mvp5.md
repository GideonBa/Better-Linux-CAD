...
is explicitly rejected as the selected drive. Blocks 48–52 Body identity, persistent feature
Body-result operations, dependencies, and body-scoped recompute are implemented; Block 53
multi-body compatibility and body-result inspection is the next technical step.
