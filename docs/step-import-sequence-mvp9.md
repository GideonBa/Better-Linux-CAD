# STEP Import Sequence MVP-9

Status: queued after Interactive Sketcher MVP-8. Blocks 122–128 are planned; Block 122 follows
after Block 121 acceptance.
...
The sequence begins after Block 121 because editable imports depend on the multi-body,
...
Do not merge Blocks 122–128 into one importer. Each block crosses a different persistent or Geometry
authority boundary.
...
|---|---|
| 122 | import-mode/source task, portable-path and freshness diagnostics |
| 123 | STEP inspection preview with product/body/unit diagnostics |
| 124 | imported semantic topology display, filtering, and picking |
| 125 | insert/refresh/convert commands for immutable Reference Parts |
| 126 | EditableBody creation and downstream Part-workbench integration |
| 127 | structured product-tree preview and Project import |
| 128 | end-to-end GUI/headless equivalence and failure-atomicity acceptance |

## Block 122 — STEP source identity, modes, JSON, and freshness
...
## Block 123 — OCCT STEP/XDE reader and imported body definitions
...
## Block 124 — Stable imported topology identity and recovery
...
## Block 125 — Reference Part integration with assemblies
...
## Block 126 — EditableBody ImportedBodyFeature and downstream modeling
...
## Block 127 — Structured STEP assembly import
...
## Block 128 — Integrated STEP import acceptance and application workflows
...
After Block 128, the first STEP Import MVP is complete.

## Explicit deferrals after Block 128
...
The next phase after Block 128 must be planned from measured import and topology-recovery gaps.
