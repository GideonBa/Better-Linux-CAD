...
Status: Blocks 31–47 and Part Construction Blocks 48–76 are implemented. The Assembly MVP handoff is complete; Block 77 is the current next technical step.
...
handoff. Blocks 48–76 Body identity, body-scoped recompute/inspection, Body Booleans, and
...
Basic 3D Sketch Core, and richer Arc/Spline/Helix/Guide intent are implemented. Add 3D Sketch JSON
and semantic references according to `docs/part-construction-sequence-mvp6.md`.
