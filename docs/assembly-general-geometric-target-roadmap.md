...
Status: Blocks 31–47 and Part Construction Blocks 48–84 are implemented. The Assembly MVP handoff is complete; Block 83 is implemented; Block 84 is implemented; Block 85 is the current next technical step.
...
handoff. Blocks 48–84 Body identity, body-scoped recompute/inspection, Body Booleans, and
...
Path-following Extrude and Extruded Cut plus ProfileSectionReference and Loft Core intent/JSON are
implemented. Add Two-section Loft Geometry on arbitrary planes according to
