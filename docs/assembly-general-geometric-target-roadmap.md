...
Status: Blocks 31–47 and Part Construction Blocks 48–75 are implemented. The Assembly MVP handoff is complete; Block 76 is the current next technical step.
...
handoff. Blocks 48–75 Body identity, body-scoped recompute/inspection, Body Booleans, and
...
ShellFeature Core intent/JSON plus Geometry, DraftFeature Core intent/JSON plus Geometry, and the
Basic 3D Sketch Core are implemented. Add richer 3D curve intent according to
