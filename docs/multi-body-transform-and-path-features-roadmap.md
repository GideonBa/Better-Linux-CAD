...
Feature Body-operation persistence, body-scoped recompute/inspection, and BodyBooleanFeature Core
intent are implemented through Block 54. The current handoff is Block 55 Body boolean Geometry and
recompute.
...
`docs/part-multi-body-recompute-mvp6.md`, `docs/part-multi-body-inspection-mvp6.md`, and
`docs/part-body-boolean-mvp6.md`; the
