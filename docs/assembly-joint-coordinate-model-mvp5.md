...
Blocks 48–63 Body identity, body-scoped recompute/inspection, Body Booleans, associative Body
...
are also implemented; Block 64 General Linear Pattern Geometry is next. Blocks 59–60
