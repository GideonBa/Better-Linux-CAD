...
Status: Blocks 23–47 and Part Construction Blocks 48–76 are implemented. The Assembly MVP sequence is complete; Block 77 is the current next technical step.
...
Blocks 48–76 Body identity, body-scoped recompute/inspection, Body Booleans, and
...
DraftFeature Core intent/JSON in Block 73, Geometry in Block 74, and the Basic 3D Sketch Core in
Block 75, and richer 3D curve intent in Block 76. The current next technical step is Block 77 3D Sketch JSON and semantic references.
