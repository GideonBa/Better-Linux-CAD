...
Status: Blocks 23–47 and Part Construction Blocks 48–75 are implemented. The Assembly MVP sequence is complete; Block 76 is the current next technical step.
...
Blocks 48–75 Body identity, body-scoped recompute/inspection, Body Booleans, and
...
Block 75. The current next technical step is Block 76 richer 3D curve intent.
