...
Status: Blocks 23–47 and Part Construction Blocks 48–61 are implemented. The Assembly MVP sequence is complete; Block 62 is the current next technical step.
...
are also implemented. The current next technical step is Block 62 Revolve/RevolveCut Geometry.
