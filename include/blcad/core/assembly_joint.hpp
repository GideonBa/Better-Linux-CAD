...
// Persistent solver-independent motion relationship intent. The first family is
// a revolute joint between two semantic seating endpoints. Limits and coordinate
// are authored angle intent; graph connectivity, residuals, Jacobians, and solve
// state remain derived.
class AssemblyJoint {
public:
