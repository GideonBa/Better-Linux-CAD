...
SketchRepairPresentationSnapshotEntry::SketchRepairPresentationSnapshotEntry(
    ...
    std::string title, std::string description, std::string label_id,
    SketchRepairDisplayCategory category, SketchRepairDisplayPriority priority,
    SketchRepairAffectedCounts affected_counts, std::string affected_summary)
...
std::size_t SketchRepairPresentationSnapshotEntry::index() const noexcept { return index_; }
bool SketchRepairPresentationSnapshotEntry::latest() const noexcept { return latest_; }
SketchRepairTransactionStatus SketchRepairPresentationSnapshotEntry::transaction_status() const noexcept {
  return transaction_status_;
}
SketchRepairSuggestionAction SketchRepairPresentationSnapshotEntry::action() const noexcept {
  return action_;
}
const std::string& SketchRepairPresentationSnapshotEntry::target() const noexcept { return target_; }
bool SketchRepairPresentationSnapshotEntry::undoable() const noexcept { return undoable_; }
const std::string& SketchRepairPresentationSnapshotEntry::title() const noexcept { return title_; }
...
const SketchRepairAffectedCounts& SketchRepairPresentationSnapshotEntry::affected_counts() const noexcept {
...
std::size_t SketchRepairPresentationSnapshot::entry_count() const noexcept { return entries_.size(); }
bool SketchRepairPresentationSnapshot::empty() const noexcept { return entries_.empty(); }
const SketchRepairPresentationSnapshotEntry* SketchRepairPresentationSnapshot::latest() const noexcept {
  if (entries_.empty()) return nullptr;
  return &entries_.back();
}

SketchRepairPresentationSnapshot SketchRepairPresentationSnapshotBuilder::build(
