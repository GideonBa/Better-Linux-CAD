...
[[nodiscard]] RevoluteJointResidualDescriptor build_revolute_joint_residual(
    const AssemblySpaceAxisDescriptor& axis_a,
    const AssemblySpacePlanarDescriptor& seat_a,
    const AssemblySpaceAxisDescriptor& axis_b,
    const AssemblySpacePlanarDescriptor& seat_b,
