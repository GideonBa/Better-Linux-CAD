...
PartDocument make_left_face_cut_document(Point2 hole_center = {}) {
  ...
  auto workplane = DerivedWorkplane::create_on_feature_face(
      DatumPlaneId("workplane.base_left"), "BaseLeftFace", face_reference.value());
  REQUIRE(workplane);
  ...
  auto cut = Feature::create_subtractive_extrude(FeatureId("feature.left_hole_cut"),
                                                 "LeftHoleCut", SketchId("sketch.left_hole"),
