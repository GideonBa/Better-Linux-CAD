...
The assembly sequence is implemented through Block 47. Part Construction Blocks 48–86 add Body identity, body-scoped recompute/inspection, Body Booleans, associative Body transforms, reusable semantic Part-feature inputs, richer Extrude/Cut intent plus Geometry, persistent plus executed Revolve/RevolveCut, general Pattern and Mirror Geometry, persistent plus executed Fillet/Chamfer/Shell/Draft Geometry, persistent model-space 3D Sketch Geometry, reusable connected semantic PathCurves, Sweep/SweepCut/SweepSurface through spatial paths, twist, and guide control, path-following Extrude/Extruded Cut, and persistent plus executed multi-section Loft/LoftCut/LoftSurface Geometry; the current contract is [`docs/part-multi-section-loft-geometry-mvp6.md`](docs/part-multi-section-loft-geometry-mvp6.md). Block 87 Guided and continuity-controlled Loft is the next technical step.
