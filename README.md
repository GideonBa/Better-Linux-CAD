...
The assembly sequence is implemented through Block 47. Part Construction Blocks 48–75 add Body identity, body-scoped recompute/inspection, Body Booleans, associative Body transforms, reusable semantic Part-feature inputs, richer Extrude/Cut intent plus Geometry, persistent plus executed Revolve/RevolveCut, general Pattern and Mirror Geometry, persistent plus executed Fillet/Chamfer/Shell/Draft Geometry, and the basic model-space 3D Sketch Core; the current contract is [`docs/part-sketch-3d-core-mvp6.md`](docs/part-sketch-3d-core-mvp6.md). Block 76 — richer 3D curve intent — is the next technical step.
